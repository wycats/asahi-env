...
The embedded SquashFS superblock is not at the first `hsqs` occurrence; locate a *plausible* SquashFS superblock (major=4, sane block size) and use that offset.
